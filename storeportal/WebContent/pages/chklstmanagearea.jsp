...
<script type="text/javascript">
	...
	function doDeletePost(val) {
		...
		if(confirm('Are you sure?')){
			document.forms['ChklstPostMain'].action = 'ChklstPostDetail_areadelete.do?chklstId='+val;
			document.forms['ChklstPostMain'].submit();
		}else{
			return false;
		}
	}
	...
	function goHome() {
		document.forms['ChklstPostMain'].action = 'Login_home.do';
		document.forms['ChklstPostMain'].submit();
	}
...
<div class="container_16">
   ...
   <s:form action="ChklstPostMain_search" name="ChklstPostMain" id="ChklstPostMain"  method="post" theme="simple">
            ...
            <td colspan="8">
                ...
                <!-- <a href="ChklstPostDetail_areacreate.do" class="btnNorm2">&laquo; Create New CheckList</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;-->
              	<a href="ChklstPostMain_areapending.do" class="btnNorm2">&laquo;Area CheckList</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
               	<a href="ChklstPostMain_areastorepending.do" class="btnNorm2">&laquo; Store CheckList</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                <a href="ChklstPostMain_areacomplete.do" class="btnNorm2">&laquo; Completed My CheckList</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				<a href="ChklstPostMain_areafail.do" class="btnNorm2">&laquo; Failed My CheckList</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;         
        ...
        <table width="100%" border="0" cellspacing="1" cellpadding="5" class="buy1_table">
          ...
          <tr>
        		...
        		<td>
                  ...
                  <td> <s:url id="store" action="ChklstPostMain_storeresponse" escapeAmp="false">
        				<s:param name="chklstId" value="chklstId"></s:param>
        		...
        		<td>
        			<s:url id="deletepost" action="ChklstPostDetail_areadelete" escapeAmp="false">
        				<s:param name="chklstId" value="chklstId"></s:param>
        			</s:url>
        		
        			<s:url id="editpost" action="ChklstPostDetail_detailareaedit" escapeAmp="false">
        				<s:param name="chklstId" value="chklstId"></s:param>
        			</s:url>
