...
<script type="text/javascript">
	...
	function chooseArea(){
		...
		if(val.value==2){
			...
			document.getElementById("franchiseelabel").style.display="none";
			...
			document.getElementById("franchiseelabel").style.display="block";
	...
	function chooseFranchiseeExpiry(){
		var val=document.getElementById("userRole");
		if(val.value==4){
			document.getElementById("franchisee").style.display="block";
			document.getElementById("franchiseelabel").style.display="block";
                	...
                	<div class="boxCon">
                  	...
                  	<div class="boxConIn">
						<table width="100%" border="0" cellpadding="2" cellspacing="2">
							...
							<td width="75%"><s:textfield name="nric" id="nric" onblur="requireValue(this)" maxlength="15" />&nbsp;* &nbsp;
							...
							<tr>
								...
								<td>
									<s:select name="userRole" id="userRole" list="roles" listKey="roleId"  listValue="roleName" headerKey="" headerValue="Select Role" style="width:160px"  onblur="requireValue(this)" onchange="chooseArea();chooseFranchiseeExpiry()"/>&nbsp;<label>*</label> &nbsp;
								...
								<td align="right"><div id="franchiseelabel" style="display: none"><label for="franchiseeExpiryDate">Franchisee Expiry Date: </label>	</div></td>
								<td>
									<div id="franchisee" style="display: none"><sj:datepicker name="franchiseeExpiryDate" id="franchiseeExpiryDate" cssClass="txtBox" changeMonth="true" changeYear="true" displayFormat="dd-M-yy" buttonImageOnly="true" yearRange="1900" timepickerFormat="hh:mm" showButtonPanel="true" timepicker="true" maxlength="50" style="width:160px" onblur="requireValue(this)" />&nbsp;<label>*</label> 
									<span id="franchiseespan" class="errorspan"> </span>&nbsp; &nbsp;</div>
								</td>
								</tr>								
