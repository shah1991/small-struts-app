	...
	<div class="grid_12">
        ...
        <table>
            ...
            <td colspan="8">
                ...
                <a href="TaskPostMain_storetask.do" class="btnNorm2">&laquo; Pending Task</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                <a href="TaskPostMain_storecomplete.do" class="btnNorm2">&laquo; Completed Task</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				<a href="TaskPostMain_storefail.do" class="btnNorm2">&laquo; Failed Task</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;             </td>
        ...
        <table width="100%" border="0" cellspacing="1" cellpadding="5" class="buy1_table">
          ...
          <s:iterator value="storeFailedList" status="post">
          <tr>
        		<td align="center"><s:property  value="#post.index+1"/></td>
        		<td>
        			<s:url id="viewpost" action="TaskPostDetail_storeview.do" escapeAmp="false">
