	...
	function goTopics() {
	 ...
	 function doDeletePost(val) {
		 ...
		 if(confirm('Are you sure?')){
			document.forms[0].action = 'PostDetail_areadelete.do?id='+val;
			document.forms[0].submit();
		 }else{
				return false;
			}
	...
	<h2>${breadCrumbt1}</h2>	         
        ...
        <table>
            ...
            <td colspan="8">
                ...
                <a href="PostDetail_detailareacreate.do" class="btnNorm2">&laquo; Create New Forum Post</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
               <a href="PostMain_areapending.do" class="btnNorm2">&laquo; Pending Forum </a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
          ...
          <tr class="forum_tr">
        	...
        	<s:iterator value="areaList" status="post">
               ...
               <td >
        			 ...
        			 <s:url id="editpost" action="PostDetail_detailareaedit" escapeAmp="false">
        				<s:param name="id" value="id"></s:param>
        			</s:url>
        			<s:a href="%{editpost}">
