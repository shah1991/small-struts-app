...
<script type="text/javascript">
	...
	function doDeleteTopic(val) {
		if(confirm('Are you sure?')){
			document.forms[0].action = 'TopicMain_detaildelete.do?topicId='+val;
			document.forms[0].submit();
		}else{
			return false;
		}
   ...
   <div class="main">
   	<div class="headingBg" >
	  	...
	  	<div style="float:right; padding:2px; font-size:12px;  color:#e1e1de;">
			<s:url id="addurl" action="TopicMain_detailadd.do"/>
			<sj:dialog id="TopicDetail" href="%{addurl}" title="Topic : New"  autoOpen="false" modal="true" resizable="false" height="300" width="700"/>
	  		<sj:a href="#" indicator="indicator" button="true" openDialog="TopicDetail" buttonIcon="ui-icon-circle-plus">New Topic</sj:a>
	  		<sj:a href="#" indicator="indicator" button="true" onclick="goForums()" buttonIcon="ui-icon-bookmark">Forums</sj:a>
	  	</div> 
   </div>
  	
	<s:form action="TopicMain_search" method="post" theme="simple">
                			  ...
                			  <div class="boxCon">
			                   <display:table pagesize="20" cellspacing="1" cellpadding="5"  class="dataTable" id="data" name="topicList" requestURI="">
								...
								<display:column title="Action">
			                    	<s:url id="editurl" action="TopicMain_detailedit.do">
			                    ...
			                    <display:column property="parentName" title="Forum" style="text-align:left;" />
