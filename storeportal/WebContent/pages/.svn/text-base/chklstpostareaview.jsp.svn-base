	...
	<div class="grid_12">
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0" class="reg_table">
         ...
         <tr style="border-color: #FFFFFF"><s:iterator status="header" value="header"><td style="color:#000000;font-size: 16px;font-weight: bold;"><label><s:property/></label>&nbsp;&nbsp;</td> </s:iterator>  
         	<td style="width: 200px;color:#000000;font-size: 16px;font-weight: bold;"><label>Response AM</label></td><td style="width: 150px;color:#000000;font-size: 16px;font-weight: bold;"><label>Response Type</label></td> 
       		<td style="color:#000000;font-size: 16px;font-weight: bold;"><label>Response SM</label></td>  	
       	</tr>
