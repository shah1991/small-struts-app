	...
	<h2>Year</h2>	      
        ...
        <table width="100%" border="0" cellspacing="1" cellpadding="5" class="buy1_table">
          <tr>
            ...
            <td class="reg_head" width="80" align="center">Post</td>
          </tr>
          <tr class="forum_tr">
            <td></td>
            <td></td>
        	...
        	<s:iterator value="postCategory" status="post">
        		...
        		<td>
        			<s:url id="viewpost" action="TaskPostMain_taskpost" escapeAmp="false">
        				...
        				<s:param name="postYear" value="%{parentName}"></s:param>
        				<s:param name="postLevel" value="\'M\'" ></s:param>
                                        <s:param name="breadCrumbtmy" value="mstName"></s:param>  
        			</s:url>
        			<s:a href="%{viewpost}">
