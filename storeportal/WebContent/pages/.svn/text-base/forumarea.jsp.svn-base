...
<script type="text/javascript">
	...
	function doFetch() {
		document.forms['PostDet'].recType.value='A';
		document.forms['PostDet'].action = 'PostDetail_detailstore.do';
		document.forms['PostDet'].submit();
	}
	
	function doExit() {
		
		
		document.forms['PostDet'].action = 'PostDetail_detailcreate.do';
		document.forms['PostDet'].submit();
	}
...
<body >
	<s:form id="PostDet" name="PostDet" action="PostDetail_detailarea" theme="simple" >
