...
<script type="text/javascript">
	...
	function doFetch() {
		...
		document.forms['ChklstDetail'].action = 'ChklstPostDetail_areatemp.do';
		document.forms['ChklstDetail'].submit();
	}
	
	function doExit(){
		document.forms['ChklstDetail'].action = 'ChklstPostDetail_areacreate.do';
		document.forms['ChklstDetail'].submit();
	}
...
<body >
	<s:form id="ChklstDetail" name="ChklstDetail" action="ChklstPostDetail_areatemp" theme="simple" >
			<s:hidden name="tempHeader" id="tempHeader"/>
		
			<s:hidden name="chklstSubject"></s:hidden>
			<s:hidden name="chklstContents"></s:hidden>
