...
<script type="text/javascript">
	...
	function goExport(){
		document.forms[0].action = 'TaskPostMain_hqAreaExcel.do';
		document.forms[0].submit();
	}
	
	function goStoreExport(){
		document.forms[0].action = 'TaskPostMain_hqStoreExcel.do';
		document.forms[0].submit();
...
<%--                <li><a href="${prevUrl0}">${breadCrumbt0}</a> &raquo;</li>               --%>
	...
	<h2>${breadCrumbtm0}</h2>	         
        ...
        <table>
            ...
            <td width="30"></td>
            <td colspan="8">
                <a href="TaskPostMain_taskpost.do?postLevel=Y&portfolioId=5" class="btnNorm2">&laquo; Task Calendar</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                <a href="TaskPostDetail_detailcreate.do" class="btnNorm2">&laquo; Create New Task</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                <a href="TaskPostMain_hqtask.do" class="btnNorm2">&laquo; Manage Task</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                <a href="TaskPostMain_hqcomplete.do" class="btnNorm2">&laquo; Completed Task</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                <a href="TaskPostMain_hqfail.do" class="btnNorm2">&laquo; Manage Failed Task</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
             </td>
        ...
        <table width="100%" border="0" cellspacing="1" cellpadding="5" class="buy1_table">
          ...
          <tr>
            ...
            <td class="reg_head">Task</td>
           	<td class="reg_head" align="center">Area Response</td>
          	<td class="reg_head" align="center">Store Response</td>
          	<td class="reg_head">Start</td>
          	<td class="reg_head">End</td>
          	<td class="reg_head" colspan="2"  align="center">Action</td>
          </tr>
          <tr class="forum_tr">
            <td colspan="8"></td>
          
          </tr>
        	<s:iterator value="taskAllList" status="post">
        		<tr>
        		<td align="center"><s:property  value="#post.index+1"/></td>
        		<td >
        			<s:url id="viewpost" action="TaskPostDetail_adminview" escapeAmp="false">
                 ...
                 <td align="center">
                	 <s:url id="area" action="TaskPostMain_arearesponse" escapeAmp="false">
        				<s:param name="taskId" value="taskId"></s:param>
        			</s:url>
        			<s:a href="%{area}">
                ...
                <td align="center"> <s:url id="store" action="TaskPostMain_storeresponse" escapeAmp="false">
        				<s:param name="taskId" value="taskId"></s:param>
        			</s:url>
        			<s:a href="%{store}">
        		...
        		<td >
        			...
        			<s:url id="deletepost" action="TaskPostDetail_admindelete" escapeAmp="false">
        				<s:param name="taskId" value="taskId"></s:param>
        			</s:url>
        			<s:url id="editpost" action="TaskPostDetail_detailedit" escapeAmp="false">
        				<s:param name="taskId" value="taskId"></s:param>
        			</s:url>
        			<s:a href="%{editpost}">
          ...
          <tr class="forum_tr">
            ...
            <td >
               ...
               <sj:a href="#" indicator="indicator" button="true"  buttonIcon="ui-icon-home" cssStyle="width:110px;" onclick="goHome()">home</sj:a>
                 ...
                 <td colspan="2"><sj:a href="#" indicator="indicator" button="true"  buttonIcon="ui-icon-document" cssStyle="width:200px;" onclick="goExport()">Export To Area Excel</sj:a></td>
                  <td colspan="5"><sj:a href="#" indicator="indicator" button="true"  buttonIcon="ui-icon-document" cssStyle="width:210px;" onclick="goStoreExport()">Export To Store Excel</sj:a></td>
