...
<div class="container_16">
   <jsp:include page="/include/userheader.jsp"/>  
	...
	<div class="grid_12">
      ...
      <tr style="border-color: #FFFFFF"><s:iterator status="header" value="header"><td class="tdborder"><label><s:property/></label>&nbsp;</td> </s:iterator> <td class="tdborder"><label>Response SM</label></td> <td class="tdres"><label>Response Type</label></td> 
      			<td class="tdborder"><label>Response AM</label></td></tr>  
