	...
	<div class="grid_12">
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0" class="reg_table">
          ...
          <tr>
            ...
            <td class="reg_head" colspan="2">CheckList Details : &nbsp;<s:property value="chklstSubject" /></td>
          </tr>
          <tr>
            <td><label for="startDate">Start Date</label></td>
            <td colspan="2"> <s:property value="chklstStartDate"></s:property></td>
          </tr>
          <tr>
            <td><label for="endDate">End Date</label></td>
            <td colspan="2"><s:property value="chklstEndDate"></s:property></td>
           
          </tr>
          <tr>
          	<td><label for="chklstName">Subject</label></td>
            <td colspan="2"> <s:property value="chklstSubject"></s:property></td>
                  
          </tr>

          <tr>
           <td><label for="chklstContents">Content</label></td> <td colspan="2">
        			  <sjr:tinymce 
								id="chklstContents" 
								name="chklstContents" 
								rows="5" 
      ...
      <tr style="border-color: #FFFFFF"><s:iterator status="header" value="header"><td class="tdborder"><label><s:property/></label>&nbsp;</td> </s:iterator> <td class="tdborder"><label>Response SM</label></td> <td class="tdres"><label>Response Type</label></td><td class="tdborder"><label>Response AM</label></td> </tr>  
         ...
         <tr><s:iterator var="template" value="tempList"><td class="tdborder"><s:property></s:property></td></s:iterator>
          ...
          <tr>
            <td><label for="response">Remark</label></td> <td colspan="2">
        			  <sjr:tinymce 
								id="chklstRemark" 
								name="chklstRemark" 
								rows="5" 
          ...
          <tr>
           <td >
               ...
               <sj:a href="#" indicator="indicator" button="true" buttonIcon="ui-icon-arrowreturnthick-1-w" cssStyle="width:110px;" onclick="goBack()">back
              </sj:a>
               ...
               <sj:a href="#" indicator="indicator" button="true"  buttonIcon="ui-icon-home" cssStyle="width:110px;" onclick="goHome()">home</sj:a>
                 ...
                 <td align="left"><sj:a href="#" indicator="indicator" button="true"  buttonIcon="ui-icon-document" cssStyle="width:160px;" onclick="goExport()">Export To Excel</sj:a></td>
          </tr>
        </table>
