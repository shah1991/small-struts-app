...
<script type="text/javascript">
   function goHome() {
	...
	function doDeletePost(id){
		document.forms[0].action = 'FilePostDetail_detaildelete.do?fileId='+id;
		document.forms[0].submit();
...
<div class="container_16">
   ...
   <div class="grid_12">
        ...
        <s:if test="%{#session.bypassbreadCrumbfs ==0}">                   
        	<h2><s:property value="%{#session.breadCrumbfsy}"/> <s:property value="%{#session.breadCrumbfsm}"/> ${breadCrumbfsw}</h2>
        </s:if>
        <s:else>
        	<h2>${breadCrumbfsw} </h2>
        </s:else>    
 ...
 <%--       <table>
            ...
            <td colspan="8">
                ...
                <a href="FilePostDetail_create.do" class="btnNorm2">&laquo; Create New File Share</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                <a href="FilePostMain_hq.do" class="btnNorm2">&laquo; Manage File Share</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                <a href="FilePostMain_filepost.do?postLevel=Y" class="btnNorm2">&laquo; Archive File Share</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
     ...
     --%>   
        <table width="100%" border="0" cellspacing="1" cellpadding="5" class="buy1_table">
          ...
          <tr class="forum_tr">
        	...
        	<s:iterator value="folderFileList" status="post">
        		<tr>
        		<td align="center"><s:property  value="#post.index+1"/></td>
        		<td>
        			<s:url id="viewpost" action="FilePostMain_filepost" escapeAmp="false">
        				...
        				<s:param name="postLevel" value="\'P\'" ></s:param>
        				<s:param name="fileFolder" value="%{fileFolderName}" ></s:param>
                                        <s:param name="breadCrumbfsp" value="%{fileFolderName}"></s:param>                                             
        			</s:url>
        			<s:a href="%{viewpost}">
        				<span><strong><s:property value="fileFolderName"/></strong></span>
        			</s:a>                </td>
             ...
             <td >
               	   <s:url id="viewpost" action="FilePostMain_exportExcel" escapeAmp="false">
        				<s:param name="groupId" value="groupId"></s:param>
        				<s:param name="postYear" value="postYear"></s:param>
        				<s:param name="postMonth" value="postMonth"></s:param>
        				<s:param name="postDate" value="%{postDate}"></s:param>
        			...
        			<s:a href="%{viewpost}" >
        				<span><img src="images/excel.jpg" border=0/></span>
        			</s:a>    
               	</td>
              </tr>
        	</s:iterator>
