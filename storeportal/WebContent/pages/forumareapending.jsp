	...
	function goTopics() {
	 ...
	 function doDeletePost(val) {
		 if(confirm('Are you sure?')){
			document.forms[0].action = 'PostDetail_delete.do?id='+val;
			document.forms[0].submit();
		 }else{
				return false;
			}
	...
	<h2>${breadCrumbt1}</h2>	      
        ...
        <table>
            ...
            <td colspan="8">
                ...
                <a href="PostMain_area.do" class="btnNorm2">&laquo; Manage Forum Post</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        ...
        <table width="100%" border="0" cellspacing="1" cellpadding="5" class="buy1_table">
          ...
          <tr class="forum_tr">
        	...
        	<s:iterator value="areaPendingList" status="post">
        		<tr>
