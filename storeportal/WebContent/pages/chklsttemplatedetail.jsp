...
<script type="text/javascript">
	...
	function doCreateChklstTemp() {
		...
		if(tempName==""){
	   	...
	   	document.getElementById("namespan").innerHTML = "Template Name is empty";
	  	 
   		}else{
    	document.getElementById("namespan").innerHTML ="";
		document.forms['ChklstTempDetail'].action = 'ChklstTemplate_detailcreate.do';
		document.forms['ChklstTempDetail'].submit();
   		}
      /*  var post_str = "";
...
<body >
	<s:form id="ChklstTempDetail" name="ChklstTempDetail" action="ChklstTemp_detailupdate" theme="simple" >
			...
			<s:hidden name="templateHeaders" id="templateHeaders"/>
					...
					<td align="left" valign="top" style="padding-top: 10px;">
						<table width="100%" border="0" cellpadding="4" cellspacing="0">
							...
							<tr>
								...
								<td width="75%"><s:textfield name="templateName" id="templateName" maxlength="50" style="width:200px"  onblur="requireValue(this)" />
