...
<%--    <s:hidden name="breadCrumbt1" id="breadCrumbt1"/>
    <s:hidden name="breadCrumby" id="breadCrumby"/>
    <s:hidden name="breadCrumbm" id="breadCrumbm"/>
    <s:hidden name="breadCrumbw" id="breadCrumbw"/>
    <s:hidden name="prevUrl1" id="prevUrl1"/>   
    <s:hidden name="prevUrly" id="prevUrly"/>    
    <s:hidden name="prevUrlm" id="prevUrlm"/>    
    <s:hidden name="prevUrlw" id="prevUrlw"/>    
--%>   
	...
	<div class="grid_12">
	    <div class="breadcrumb">
            <ul>
                ...
                <li><a href="${prevUrlm}">Month</a> &raquo;</li>                                  
                <li><a href="${prevUrlw}">Week</a> &raquo;</li>                                  
            </ul>
        </div>
        <div class="clearfix" /></div>
        
	<h2><s:property value="%{#session.breadCrumby}"/> <s:property value="%{#session.breadCrumbm}"/> ${breadCrumbw}</h2>		
        <h3>Browse Topics</h3>
        	...
        	<s:iterator value="postList" status="post">
        		...
        		<td>
        			<s:url id="viewpost" action="PostDetail_postview" escapeAmp="false">
        				<s:param name="id" value="postId"></s:param>
        			</s:url>
        			<s:a href="%{viewpost}">
        				<span><strong><s:property value="postSubject"/></strong></span>
        			</s:a>
                </td>
        		<td>
