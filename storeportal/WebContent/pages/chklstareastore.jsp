...
<script type="text/javascript">
	function doFetch() {
		document.forms['ChklstDetail'].action = 'ChklstPostDetail_detailarea.do';
...
<body >
	<s:form id="ChklstDetail" name="ChklstDetail" action="ChklstPostDetail_detailarea" theme="simple" >
