...
function goBack()
  ...
  window.history.back();
	...
	function doSearch() {
		document.forms[0].action = 'TaskPostMain_areatask.do';
		document.forms[0].submit();
	}
	...
	function doCreatePost() {
		 var validCheck=true;
			...
			document.forms[0].action = 'TaskPostDetail_areapost.do';
			document.forms[0].submit();
		}
	...
	function doUpdatePost() {
		 var validCheck=true;
			...
			if(validCheck){
			document.forms[0].action = 'TaskPostDetail_detailareaupdate.do';
			document.forms[0].submit();
		}
	}
...
<div class="container_16">
 <br style="clear:both"/>
   <jsp:include page="/include/userheader.jsp"/>  
   	<s:form action="TaskPostDetail" name="TaskPostDetail" id="TaskPostDetail" method="post" enctype="multipart/form-data" theme="simple">
   ...
   <div class="container_16">
	<div class="grid_12">
        ...
        <h2>${prevUrltm0} ${breadCrumbtm0}</h2>	
        <s:if test="%{#session.prevUrltmw !=null}">                
