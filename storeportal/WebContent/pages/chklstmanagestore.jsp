...
<script type="text/javascript">
	...
	function goBack()
	  ...
	  function goExport(){
		document.forms[0].action = 'ChklstPostMain_storeexportExcel.do';
		document.forms[0].submit();
	}
</script>
</head>
...
<div class="container_16">
   ...
   <div class="container_16">
	<div class="grid_12">
        ...
        <h3>Area CheckList &nbsp; &nbsp;( ${topicName})</h3>
        ...
        <table>
            ...
            <td colspan="8">
                ...
                <a href="ChklstPostMain_storecomplete.do" class="btnNorm2">&laquo; Completed CheckList</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        ...
        <table width="100%" border="0" cellspacing="1" cellpadding="5" class="buy1_table">
          ...
          <s:iterator value="storePendingList" status="post">
          <tr>
        		<td align="center"><s:property  value="#post.index+1"/></td>
        		<td>
        			<s:if test="%{chklstType==\"S\"}">
        			<s:url id="viewpost" action="ChklstPostDetail_postview" escapeAmp="false">
        			...
        			<s:else>
        			 <s:if test="%{chklstStatus==\"P\"}">
	        			<s:url id="viewpost" action="ChklstPostDetail_storeview" escapeAmp="false">
	        				<s:param name="chklstId" value="chklstId"></s:param>
	        				<s:param name="chklstStoreId" value="chklstStoreId"></s:param>
	        			</s:url>
	        		 </s:if>
	        		 <s:elseif  test="%{chklstStatus==\"I\"}">
	        		 	<s:url id="viewpost" action="ChklstPostDetail_responsesm" escapeAmp="false">
	        				<s:param name="chklstId" value="chklstId"></s:param>
	        				<s:param name="chklstStoreId" value="chklstStoreId"></s:param>
	        			</s:url>
	        		</s:elseif>
