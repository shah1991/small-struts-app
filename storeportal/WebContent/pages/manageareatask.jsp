	...
	<h2>${breadCrumbtm0}</h2>	  
        ...
        <table>
            ...
            <td colspan="8">
				...
				<a href="TaskPostMain_areapending.do" class="btnNorm2">&laquo; Pending My Task</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                <a href="TaskPostMain_areacomplete.do" class="btnNorm2">&laquo; Completed My Task</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				<a href="TaskPostMain_areafail.do" class="btnNorm2">&laquo; Failed My Task</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;            
        ...
        <table width="100%" border="0" cellspacing="1" cellpadding="5" class="buy1_table">
          ...
          <tr>
            ...
            <td class="reg_head">Task</td>
          	...
          	<td class="reg_head" colspan="2">Action</td>
          </tr>
          ...
          <tr>
        		...
        		<td>
        			...
        			<s:url id="editpost" action="TaskPostDetail_detailareaedit" escapeAmp="false">
        				<s:param name="taskId" value="taskId"></s:param>
        			</s:url>
          ...
          <tr class="forum_tr">
            ...
            <td >
               ...
               <sj:a href="#" indicator="indicator" button="true"  buttonIcon="ui-icon-home" cssStyle="width:110px;" onclick="goHome()">home</sj:a>
                 ...
                 <td colspan="6"><sj:a href="#" indicator="indicator" button="true"  buttonIcon="ui-icon-document" cssStyle="width:210px;" onclick="goStoreExport()">Export To Store Excel</sj:a></td>
