...
<!-- added by Thilagar on Dec 18th 2014 -->
            ...
            <td colspan="2">
	            <table>
    				<tr><td colspan="2" class="tdborder"><label>Attachment Proof Name</label></td></tr>
    				<tr><td colspan="2" class="tdborder">	
                                    <s:iterator value="taskResponseAreaList">                                              
		 			<a href=".<s:property value="taskProofPath"/>" target="_blank" style="width:200px"> 
                                ...
                                <tr>
                                    <td colspan="2" class="tdborder">
                                        <s:iterator value="taskResponseAreaList">                                                                            
                                            <img src=".<s:property value="taskProofPath"></s:property>" style="width:100px;height:100px;"></img>
                                       </s:iterator>
                                    </td>
    			 	</tr>          
      			</table>
