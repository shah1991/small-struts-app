	...
	<div class="grid_12">
        ...
        <table>
            ...
            <td colspan="8">
                ...
                <a href="ChklstPostDetail_areacreate.do" class="btnNorm2">&laquo; Create New CheckList</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
              	<a href="ChklstPostMain_areapending.do" class="btnNorm2">&laquo; Pending My CheckList</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        ...
        <table width="100%" border="0" cellspacing="1" cellpadding="5" class="buy1_table">
           ...
           <td class="reg_head" width="30" align="center">No</td>
            <td class="reg_head" colspan="8">Store Name</td>
           </tr>
     
         
          <s:iterator value="selectStoreList" status="post">	
           <tr>
           <td align="center"><s:property  value="#post.index+1"/></td>
           <td colspan="9">
          <s:url id="viewpost" action="ChklstPostMain_storeforarea.do" escapeAmp="false">
        				<s:param name="storeId" value="storeId"></s:param>
        				
        			</s:url>
        			<s:a href="%{viewpost}">
        				<span><strong><s:property value="storeName"/></strong></span>
        			</s:a>
