        ...
        <table width="100%" border="0" cellspacing="1" cellpadding="5" class="buy1_table">
          ...
          <tr class="forum_tr">
        	...
        	<s:iterator value="topicList" status="topic">
        		...
        		<td colspan="2">
        			<s:url id="viewpost" action="PostMain_entry" escapeAmp="false">
        				<s:param name="topicId" value="id"></s:param>
        				<s:param name="breadCrumbt1" value="mstName"></s:param>
                                        <s:param name="bc1" value="0"></s:param>
        				
        			</s:url>
        			<s:a href="%{viewpost}">
        				<span style="text-transform: uppercase;"><strong><s:property value="mstName"/></strong></span>
        			</s:a>
                </td>
        		<td>
