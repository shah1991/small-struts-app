...
<script type="text/javascript">
	...
	if(userOldPass==""){
		...
		if(userPass.length>7){
			 var pattern =/^[A-Z][A-Za-z0-9_.,^&*$%#@!~+=;:|-]{2,19}$/;
		        if (pattern.test(userPass)) {
		        	...
		        	document.getElementById("pwdspan").innerHTML ="Password first letter should be Capital or Given special character not allowed";
		...
		if(validCheck){
		document.forms['UserDetail'].action = 'UserDetail_changePwd.do';
...
<div class="container_16">
   <jsp:include page="/include/userheader.jsp"/>  
    ...
    <h3>Change Password</h3>
  	<table align="center" width="100%" border="0" cellspacing="2" cellpadding="2"><tr><td>
