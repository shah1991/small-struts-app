	...
	<div class="grid_12">
        ...
        <table>
            ...
            <td colspan="8">
                ...
                <a href="ChklstPostMain_areacomplete.do" class="btnNorm2">&laquo; Completed CheckList</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				<a href="ChklstPostMain_areafail.do" class="btnNorm2">&laquo; Failed CheckList</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;             </td>
        ...
        <table width="100%" border="0" cellspacing="1" cellpadding="5" class="buy1_table">
          ...
          <tr>
        		...
        		<td>
        			<s:url id="viewpost" action="ChklstPostMain_choosestore.do" escapeAmp="false">
        		...
        		<td><s:property value="chklstResponseType" /></td>        		
                </tr>
                </s:iterator>
          <tr class="forum_tr">
            <td></td>
